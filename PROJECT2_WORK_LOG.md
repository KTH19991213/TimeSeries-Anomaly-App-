...
- Project 1 feedback showed a weakness in differentiation: "basic function: 3, basic UI: 3, deployment: 2, differentiation function/UI: 0." Project 2 therefore needs an obvious difference beyond a normal upload-and-chart app.
...
- The main differentiation feature is the anomaly intelligence layer:
  ...
  - a differentiation tab that makes the difference from baseline submissions explicit
